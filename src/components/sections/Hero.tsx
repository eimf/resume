    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-6">
      <div className="section-container w-full text-center">
        ...
        <div ref={contentRef} className="space-y-6">
          ...
          <div className="flex items-center justify-center gap-4 opacity-0">
            <a
              href="https://github.com/eimf"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-surface-border text-text-secondary hover:text-accent hover:border-accent/50 transition-all duration-300 text-sm font-mono"
            >
              <GitHubIcon />
              GitHub
            </a>
            ...
            <a
              href="#contact"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-accent text-surface font-medium hover:bg-accent-hover transition-all duration-300 text-sm"
            >
              Let's Connect
            </a>
          </div>
      ...
      <div ref={scrollRef} className="absolute bottom-8 left-1/2 -translate-x-1/2 opacity-0">
        <div className="flex flex-col items-center gap-2">
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" className="text-accent">
            <path d="M8 1v12M3 9l5 5 5-5" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
    </section>
