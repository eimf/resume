        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="animate-item opacity-0 grid grid-cols-2 gap-4">
            <div className="glass-card p-5 space-y-3">
              <h3 className="text-xs font-mono text-text-muted uppercase tracking-wider">Then</h3>
            ...
            <div className="glass-card p-5 space-y-3 border-accent/30">
              <h3 className="text-xs font-mono text-accent uppercase tracking-wider">Now</h3>
              <ul className="space-y-2 text-sm text-text-secondary">
                <li className="flex items-start gap-2">
